...
<div class="page-wrapper">
  <header class="page-header clearfix" role="header">
    <div class="inner">
      <div class="header-left large-3 medium-4 small-12 columns circle-columns-column">
        <?php if ($logo): ?>
      ...
      <div class="header-right large-9 medium-8 small-12 columns circle-columns-column">
